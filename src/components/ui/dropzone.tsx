...
interface DropzoneRemoveFileProps extends React.ComponentProps<typeof Button> {}
...
interface DropzoneRetryFileProps extends React.ComponentProps<typeof Button> {}
